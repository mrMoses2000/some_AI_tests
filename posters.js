import { Renderer, Camera, Transform, Plane, Program, Mesh, Texture } from 'https://unpkg.com/ogl@1.0.11/src/index.js?module';
...
export function initFlyingPosters(container, items = []) {
...
document.addEventListener('DOMContentLoaded', () => {
  const container = document.querySelector('#gallery .posters-container');
  if (!container) return;
  const images = [
    'images/our_church_1.jpg',
    'images/our_church_2.jpg',
    'images/our_church_3.jpg',
    'images/our_church_4.jpg',
    'images/our_church_5.jpg',
    'images/our_church_6.jpg',
    'images/anton.png',
    'images/moses.png',
    'images/serik.png',
    'images/sherzat.png'
  ];
  initFlyingPosters(container, images);
});
